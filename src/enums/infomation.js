const info = {
  ...
  time: [
    {
      ...
      project: "Dragon Capital (CMS, DragonX, DragonS, Pension), HKT Group",
      description: [],
  ...
  projects: [
    ...
    },
    {
      ...
      position: "Frontend Developer",
      description: "B2B, B2C",
      techs: ["Vuejs", "VueX", "Vuetify", "Tailwind CSS"],
      size: "4",
      production: "https://dragonx.com.vn/",
    },
  ],
  contact: ["Hungthinh.ckc@gmail.com"],
